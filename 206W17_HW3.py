...
for line in f:
    line = line.rstrip()
    if re.findall("\B[0-9](.d)(ocx)", line): 
        w.append(line)
    if re.findall("\B[0-9](.x)(lsx)", line):
        w.append(line)
microsoft_files_num=len(w)
